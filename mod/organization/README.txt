...
To Use
===========
i) Replace all instances of ORGANIZATION with your uppercase module name eg WIDGET
There are about 3 of these.

ii) Replace all instances of MOD_ORGANIZATION_ with your module frankenstyle component name eg MOD_WIDGET_
(NB note the trailing underscore. Just to be safe, include that.)
There are over 140 of these.

iii) Replace all instances of organization with your lowercase module name eg widget
There are over 330 of these.

iv) Replace all instances of 2019 Experion Moodle chikku.pa@experionglobal.com_ with something like "2015 Justin Hunt".
