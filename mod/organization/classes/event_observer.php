...
/**
 * Event observer for mod_organization
 *
 * @package    mod_organization
 * @copyright  2019 Experion Moodle chikku.pa@experionglobal.com_
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class event_observer{
    ...
    public static function course_deleted(\core\event\course_deleted $event) {
       global $DB;
		//MOD_ORGANIZATION_TABLE should be deleted elsewhere
		...
		$ret = $DB->delete_records(MOD_ORGANIZATION_USERTABLE,array('courseid'=>$event->objectid));
		return $ret;
	}
}
