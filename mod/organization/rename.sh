...
find ./NEWMODULE -type f -exec sed -i "s|ORGANIZATION|${MODULENAME}|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|MOD_ORGANIZATION_|MOD_${MODULENAME}_|g" {} \;
find ./NEWMODULE -type f -exec sed -i "s|organization|${LMODULENAME}|g" {} \;
printf "enter the year, your name and email address on one line for the copyright notice. eg 2015 John Doe jdoe@email.com \n" 
read 2019 Experion Moodle chikku.pa@experionglobal.com_
find ./NEWMODULE -type f -exec sed -i "s|2019 Experion Moodle chikku.pa@experionglobal.com_|${2019 Experion Moodle chikku.pa@experionglobal.com_}_|g" {} \; 
